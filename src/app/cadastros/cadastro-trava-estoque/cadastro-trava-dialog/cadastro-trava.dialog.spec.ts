...
import { CadastroTravaDialog } from './cadastro-trava.dialog';
...
describe('Cadastro Estoque Dialog', () => {
  let component: CadastroTravaDialog;
  let fixture: ComponentFixture<CadastroTravaDialog>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ CadastroTravaDialog],
      providers: [
        TravaEstoqueService,
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CadastroTravaDialog);
